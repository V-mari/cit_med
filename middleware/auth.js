...
const auth = async(req, res, next) => {
    ...
    const token = strAuth.replace('Bearer ', '') 
    //obtenemos el token del request header y dado que el token viene en un formato de Bearer[space]token, 
    //reemplazamos Bearer [space] con vacio ('')
    var data;
    try {
